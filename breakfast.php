...
$class= 'hide';
            ...
            echo "<div id=".$dbRow["RecipeID"]." data-finish='false' <div class=".$class."><h4><div>".$dbRow["RecipeName"].
         "</h4>"."<br><img src=Breakfast/".$dbRow['RecipePicture']."' width='150' height='150' />".
			"</b><br><br>".$dbRow["RecipeInstructions"]."
			<form method='POST'><input type='hidden' name='RecipeID' value= '".$dbRow['RecipeID']." '>
			<input type='submit' name=".$dbRow["RecipeID"]." value='Completed Recipe' class='button-recipe'>id=".$dbRow["RecipeID"].
			"</form></div>";
	  $cnt++;
