...
$class= "style=display:block";
            ...
            echo "<b><br><br><h4><div id=".$dbRow["RecipeID"]."class='style=display:none'</b>".$dbRow["RecipeName"].
			...
			<input type='submit' name=".$row["RecipeID"]."name='submit' value='Completed Recipe' class='button-recipe'></form>";
	  $ctn++;
	  var_dump($ctn);
}
